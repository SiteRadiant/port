...
export const partnerLogos = [
  ...
  { name: 'Discord', color: '#5865F2' }, { name: 'Duolingo', color: '#58CC02' },
  { name: 'Snapchat', color: '#FFFC00' }, { name: 'Telegram', color: '#26A5E4' },
  { name: 'Krisp', color: '#ef4444' }, { name: 'CapCut', color: '#000000' },
  { name: 'ClickUp', color: '#dc2626' }, { name: 'Wise', color: '#9FE870' },
  { name: 'Envato', color: '#82B541' }, { name: 'Medium', color: '#ffffff' },
  { name: 'Trello', color: '#0079BF' }, { name: 'Behance', color: '#1769FF' },
  { name: 'Coursera', color: '#0056D2' }, { name: 'Freepik', color: '#1273EB' },
  { name: 'TradingView', color: '#2962FF' }, { name: 'Quora', color: '#B92B27' },
];
