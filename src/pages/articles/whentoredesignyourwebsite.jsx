...
export default function ArticlePage() {
  const schema = {
    ...
    "@type": "Article",
    "headline": "When Should a Business Redesign Its Website?",
    "publisher": {
      "@type": "Organization",
      "name": "SiteRadiant"
    },
    "description": "7 clear signs your outdated website is costing you leads, and when its time for a complete website redesign."
  };

  return (
    <div className="min-h-screen bg-[#0a0a0b] text-white">
      <SEO title="When Should a Business Redesign Its Website? | SiteRadiant Insights" description="7 clear signs your outdated website is costing you leads, and when its time for a complete website redesign." path="/when-to-redesign-your-website" schema={schema} />
      <Navbar />
      <article className="pt-32 pb-16 max-w-3xl mx-auto px-6">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-8">When Should a Business Redesign Its Website?</h1>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-12">
          ...
          <p className="text-zinc-300">7 clear signs your outdated website is costing you leads, and when its time for a complete website redesign.</p>
        </div>
