...
export default function ArticlePage() {
  const schema = {
    ...
    "@type": "Article",
    "headline": "How Much Does a Custom Website Cost?",
    "publisher": {
      "@type": "Organization",
      "name": "SiteRadiant"
    },
    "description": "A complete breakdown of custom website development costs, including design, frontend, and backend architecture pricing."
  };

  return (
    <div className="min-h-screen bg-[#0a0a0b] text-white">
      <SEO title="How Much Does a Custom Website Cost? | SiteRadiant Insights" description="A complete breakdown of custom website development costs, including design, frontend, and backend architecture pricing." path="/how-much-does-a-custom-website-cost" schema={schema} />
      <Navbar />
      <article className="pt-32 pb-16 max-w-3xl mx-auto px-6">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-8">How Much Does a Custom Website Cost?</h1>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-12">
          ...
          <p className="text-zinc-300">A complete breakdown of custom website development costs, including design, frontend, and backend architecture pricing.</p>
        </div>
